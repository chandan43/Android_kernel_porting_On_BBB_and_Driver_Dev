...
static const struct platform_device_id onboardled_id_table[] = {
	//{.compatible = "gpio-extled",-1},
	{"gpio-extled",-1},
	{},
};
MODULE_DEVICE_TABLE(platform,onboardled_id_table);
